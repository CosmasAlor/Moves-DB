...
import { GetPopular } from '@/redux/UpcomingSlice';
...
const PopularMovies: React.FC = () => {
  ...
  const { popularMovies, isLoading, error } = useSelector((state: RootState) => state.upcoming);
  ...
  return (
    <>
    <h1 className="mb-2 text-2xl font-bold tracking-tight text-gray-100 dark:text-white">Most Popular Movies</h1>
